...
>
    @push('meta_tags')
        ...
        <meta property="og:image" content="{{ empty($headImageUrl) ? url('storage/images/site-logo.jpg') : $headImageUrl }}" />
        ...
        <meta name="twitter:image" content="{{ empty($headImageUrl) ? url('storage/images/site-logo.jpg') : $headImageUrl }}" />
